# Migration `20190808024227-init`

This migration has been generated by Yosuke Kurami at 8/8/2019, 2:42:27 AM.
...
You can use a specific Photon built for this migration (20190808024227-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190808024227-init'
